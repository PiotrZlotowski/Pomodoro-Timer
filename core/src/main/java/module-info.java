...
module pz.time.core {
    ...
    uses Operation;
    provides Operation with RemainingTimeFormatter, TimerTitleKeeper, BluePanelBackground, GreenPanelBackground, StopTextTimerButton;
